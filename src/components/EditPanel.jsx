...
function EditPanel() {
  ...
  return (
    ...
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-2xl shadow-lg w-full mt-10">
      <h2 className="text-2xl font-bold text-center text-blue-500">Editar Perfil</h2>
      ...
      <form className="grid grid-cols-2 gap-4">
        <div>
          ...
          <input type="date" className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-300" />
        </div>
        <div>
          <label className="block font-medium">CPF/CNPJ</label>
          <input type="text" className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-300" />
        </div>
        <div>
        ...
        <div className="col-span-2">
          <button className="w-full bg-blue-500 text-white py-2 rounded-lg hover:bg-blue-600 transition">Salvar</button>
        </div>
      </form>
    </div>
    </div>
